        ...
        if member.bot:
            if data["vcrole"]["bots"] == "":
                ...
                if not before.channel and after.channel:
                    ...
                    await member.add_roles(br, reason="Dilbar Support | VC Roles (Joined VC)")
                elif before.channel and not after.channel:
                    r1 = data["vcrole"]["bots"]
                    br1 = get(member.guild.roles, id=r1)
                    await member.remove_roles(br1, reason="Dilbar Support | VC Roles (Left VC)")
            ...
            if data["vcrole"]["humans"] == "":
                ...
                if not before.channel and after.channel:
                    ...
                    await member.add_roles(br2, reason="Dilbar Support | VC Roles (Joined VC)")
                elif before.channel and not after.channel:
                    r3 = data["vcrole"]["humans"]
                    br3 = get(member.guild.roles, id=r3)
                    await member.remove_roles(br3, reason="Dilbar Support | VC Roles (Left VC)")